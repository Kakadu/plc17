...
Refinement: извлечение посчитанных ответов & $\inml{refine} \colon \sigma\to X\to T$ \vspace*{-\baselineskip}\pause
\end{tabular}
...
% \item Outperforms $\mu$Kanren (\url{https://github.com/Kakadu/ocanren-perf})
% \end{itemize}
%
% \end{frame}
